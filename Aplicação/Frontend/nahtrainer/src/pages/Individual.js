...
const IndividualTable = () => {
  const [individuals, setIndividuals] = useState([
    { id: 1, title: 'Individual A', horario: '7:00', dia: 'Segunda', data_inicio: '2023-01-15' },
    { id: 2, title: 'Individual B', horario: '18:00', dia: 'Terça', data_inicio: '2023-01-16' },
  ]);
  ...
  const TableRow = (props) => {
    const { id, title, horario, dia, data_inicio } = props;
